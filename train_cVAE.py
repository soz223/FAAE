...
def process():
    ...
    train_covariates.Diagnosis[train_covariates.Diagnosis == 17] = 0       #
    ...
    age_bins_train, bin_edges = pd.qcut(train_covariates['Age'].rank(method="first"), q=10, retbins=True, labels=bin_labels)
